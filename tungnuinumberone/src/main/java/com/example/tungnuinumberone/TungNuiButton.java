package com.example.tungnuinumberone;
...
public class TungNuiButton extends RelativeLayout {
    ...
    public TungNuiButton(Context context) {
        super(context);
    ...
    public TungNuiButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.attrs = attrs;
        initView();
    ...
    public TungNuiButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnValueChangeListener {
        void onValueChange(TungNuiButton view, int oldValue, int newValue);
    }
